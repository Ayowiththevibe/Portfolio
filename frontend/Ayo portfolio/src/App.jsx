...
const App = () => {
  ...
  return (
    <div style={{ width: '100%', maxWidth: '100vw', overflowX: 'hidden', backgroundColor: '#0B0B0D', color: '#E8E8EC', fontFamily: 'monospace' }}>
      ...
      {/* ── HERO ── */}
      <section className="min-h-screen flex flex-col justify-center px-6 md:px-12 pt-28 pb-16">
        ...
        <h1 className="text-3xl sm:text-5xl md:text-7xl font-extrabold text-[#C8F564] leading-tight tracking-tight overflow-hidden">
          {typed}<span className="inline-block w-[3px] h-[0.8em] bg-[#C8F564] ml-1 align-middle animate-pulse"></span>
        </h1>

        <p className="text-[#6B6B78] text-sm md:text-lg leading-relaxed mt-6 max-w-sm md:max-w-md">
        ...
        <div className="flex items-center gap-2 mt-5 w-fit px-4 py-2" style={{ backgroundColor: '#1A2A0A' }}>
        ...
        <div className="flex flex-wrap gap-3 mt-7">
          <a href="#contact">
            <button className="bg-[#C8F564] text-[#0B0B0D] font-bold text-sm uppercase tracking-wider px-6 py-3 md:px-8 md:py-4 hover:-translate-y-0.5 transition-all duration-200">
              Hire Me
            </button>
          </a>
          <a href="Adebanjo Ayomide CV 2.pdf" target="_blank" rel="noopener noreferrer">
            <button className="border border-[#1E1E26] text-white font-semibold text-sm uppercase tracking-wider px-6 py-3 md:px-8 md:py-4 hover:border-[#C8F564] hover:text-[#C8F564] transition-all duration-200">
              View Resume
            </button>
          </a>
        </div>
      ...
      {/* ── ABOUT ── */}
      <section id="about" className="border-t border-[#1E1E26] px-6 md:px-12 py-16 md:py-24">
        <LazySection>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12" style={{ minWidth: 0 }}>
            {/* FIX: image has fixed size on mobile so it doesn't take up full screen */}
            <div className="rounded-sm relative flex items-center justify-center overflow-hidden w-48 sm:w-64 md:w-80 mx-auto">
              <img src="/Ayo.png" alt="Ayomide" loading="lazy" className="w-full h-full object-contain" />
            </div>

            <div className="min-w-0">
              <p className="text-[#6B6B78] text-sm md:text-base leading-loose break-words">
              ...
              <div className="grid grid-cols-2 gap-px mt-8 bg-[#1E1E26] border border-[#1E1E26]">
                {[
                  ...
                  <div key={label} className="bg-[#131316] px-4 py-5 md:px-6 md:py-6">
                    <p className="text-2xl md:text-3xl font-extrabold text-[#C8F564] tracking-tight">{num}</p>
      ...
      {/* ── TECH STACK ── */}
      <section id="stack" className="border-t border-[#1E1E26] px-6 md:px-12 py-16 md:py-24">
        <LazySection>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-px bg-[#1E1E26] border border-[#1E1E26]">
            {['React.js', 'Node.js', 'JavaScript', 'Firebase', 'MongoDB', 'Express', 'PostgreSQL', 'Tailwind CSS', 'REST APIs', 'Git & Github'].map((sk) => (
              <div
                key={sk}
                className="bg-[#131316] text-[#6B6B78] hover:bg-[#C8F564] hover:text-[#0B0B0D] px-3 py-4 text-center text-xs font-semibold tracking-wide transition-all duration-200 cursor-default"
              >
                {sk}
              </div>
            ))}
      ...
      {/* ── PROJECTS ── */}
      <section id="projects" className="border-t border-[#1E1E26] px-6 md:px-12 py-16 md:py-24">
        <LazySection>
          <div className="flex items-center gap-3 mb-8">
            <span className="w-1 h-10 bg-[#C8F564] shrink-0"></span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-[#131316] border border-[#1E1E26] rounded-2xl overflow-hidden hover:border-[#C8F564] transition-all duration-300 group">
              ...
              <div className="p-5">
                {/* FIX: badge wraps below title on mobile instead of squishing */}
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 mb-3">
                  <h3 className="text-white font-bold text-base leading-snug">Event Ticketing & Venue Platform</h3>
                  <span className="bg-[#C8F564] text-[#0B0B0D] text-[10px] font-bold uppercase tracking-wider px-3 py-1.5 w-fit shrink-0">
                    In Progress
                  </span>
                </div>
            ...
            <div className="bg-[#131316] border border-[#1E1E26] rounded-2xl overflow-hidden hover:border-[#C8F564] transition-all duration-300 group">
              <div className="w-full aspect-video bg-[#0F0F12] overflow-hidden relative">
                ...
                {/* FIX: hover overlay hidden on mobile (no hover on touch), links shown below instead */}
              ...
              <div className="p-5">
                <h3 className="text-white font-bold text-base leading-snug mb-2">CinemaAccess</h3>
                {/* FIX: show text links on mobile since hover overlay doesn't work on touch */}
                <div className="flex gap-4 mb-3 sm:hidden">
                  <a href="https://github.com/Ayowiththevibe/cinemaaccess" target="_blank" rel="noopener noreferrer"
                    className="text-[#C8F564] text-xs uppercase tracking-widest font-bold">GitHub</a>
                  <a href="https://cinemaaccess-6710a.web.app/" target="_blank" rel="noopener noreferrer"
                    className="text-[#C8F564] text-xs uppercase tracking-widest font-bold">Live Demo</a>
                </div>
      ...
      {/* ── CONTACT ── */}
      <section id="contact" className="border-t border-[#1E1E26] px-6 md:px-12 py-16 md:py-24">
        <LazySection>
          <div className="flex items-center gap-3 mb-10">
            <span className="w-1 h-10 bg-[#C8F564] shrink-0"></span>
          ...
          <div className="flex flex-col md:flex-row gap-12 md:gap-16 items-start">
            {/* FIX: heading scaled down on mobile, was too big */}
            <div className="md:w-1/2">
              <h1 className="text-4xl md:text-6xl font-extrabold text-white tracking-tight leading-tight">Let's build</h1>
              <h1 className="text-4xl md:text-6xl font-extrabold text-[#C8F564] tracking-tight leading-tight mb-5">something.</h1>
              <p className="text-[#6B6B78] text-sm md:text-base leading-relaxed">

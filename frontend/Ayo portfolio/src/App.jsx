          ...
          <div className="flex flex-col md:flex-row gap-16 items-start">
            ...
            <div className="md:w-1/2 w-full flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input type="text" id="subject" placeholder="Subject of your mail"
                  className="bg-[#131316] border border-[#1E1E26] text-white text-sm px-4 py-3 w-full focus:outline-none focus:border-[#C8F564] transition-colors placeholder:text-[#2E2E38]" />
              </div>
              <div className="flex flex-col gap-1.5">
              ...
              <button className="bg-[#C8F564] text-[#0B0B0D] font-bold text-sm uppercase tracking-wider px-8 py-4 w-full hover:-translate-y-0.5 transition-all duration-200">
                Send Message
              </button>
            </div>
